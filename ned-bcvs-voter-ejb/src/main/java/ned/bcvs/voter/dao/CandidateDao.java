...
public class CandidateDao {
    ...
    public CandidateDao(String candidateHash, String candidateId, String firstName, String lastName, String voterId, int ConstituencyId, int electionSymbolId, String candidateType) {
    ...
    public CandidateDao(Connection con, String candidateId){
        try {
            ...
            Logger.getLogger(VoterDao.class.getName()).log(Level.SEVERE, null, ex);
          }
    }
